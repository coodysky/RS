...
namespace DbModel.Models
{
    public class ResponseRecord
    {
        ...
        public static string GetSqlForInsert(ResponseRecord responserecord)
        {
            ...
            dicNameValue.Add("Title", responserecord.Title ?? "");
            if (responserecord.Price != null)
            {
                dicNameValue.Add("Price", responserecord.Price.ToString());
            }
        ...
        public static string GetSqlForInsertAndQueryIdentity(ResponseRecord responserecord)
        {
            string sql = string.Empty;
